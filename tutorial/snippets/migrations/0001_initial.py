# Generated by Django 2.1.3 on 2019-05-21 07:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phonenumber2', models.CharField(blank=True, default='', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='snippets.Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status', to='snippets.Parking')),
            ],
            options={
                'ordering': ('created',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relatedname1', models.CharField(blank=True, default='', max_length=100)),
                ('relatedname2', models.CharField(blank=True, default='', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Concept',
            fields=[
                ...
                ('inquiry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='concepts', serialize=False, to='snippets.Inquiry')),
        ...
        migrations.AddField(
            model_name='service',
            name='tags',
            field=models.ManyToManyField(to='snippets.Tags'),
        ),
        migrations.AddField(
            model_name='parking',
            name='owner',
        ...
        migrations.AddField(
            model_name='carousel',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carousels', to='snippets.Category'),
        ),
        migrations.AddField(
            model_name='carousel',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carousels', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='concept',
            name='service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='concepts', to='snippets.Service'),
        ),
    ]
